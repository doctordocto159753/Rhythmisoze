...
| [performance-budgets.md](performance-budgets.md) | PRD §8 targets and how each is instrumented | Instrumented, not yet measured on the matrix |

## How to run what exists

```bash
npm run test                 # 372 unit tests, including the humtool parity suite
