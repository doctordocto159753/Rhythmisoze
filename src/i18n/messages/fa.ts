...
export const fa: Messages = {
  ...
  versions: {
    ...
    names: {
      unprocessed: 'همان چیزی که خواندی',
    ...
    hints: {
      unprocessed: 'نزدیک‌ترین خوانش به چیزی که واقعاً خواندی.',
    ...
    // برای فایل MIDI واردشده صادقانه توصیف شده: چیزی خوانده نشده و رونویسی‌ای
    // در کار نبوده که ابهامی داشته باشد.
    importedHints: {
      unprocessed: 'فایل دقیقاً همان‌طور که رسید.',
    },
    // همان نسخه، با نامی که به ریتم می‌خورد. «چیزی که خواندی» واژه‌ی ملودی است.
    rhythmNames: {
