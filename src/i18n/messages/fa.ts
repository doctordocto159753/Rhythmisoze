...
export const fa: Messages = {
  ...
  landing: {
    ...
    bodyWithWitness:
      'ضبط تو به سرویس رونویسی همین سایت فرستاده می‌شود تا موتور دومی آن را بررسی کند، و بعد از خوانده‌شدن همان‌جا پاک می‌شود. داده‌ی نت‌ها فقط وقتی به نوازنده می‌رود که نسخه‌ی بیشتری بخواهی.',
    start: 'شروع یک اسکچ',
